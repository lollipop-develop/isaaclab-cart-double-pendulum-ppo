...
parser = argparse.ArgumentParser(description="Play a trained PPO policy on the cart double pendulum.")
...
from env import CartDoublePendulumEnv, CartDoublePendulumEnvCfg  # noqa: E402


def main():
    cfg = CartDoublePendulumEnvCfg()
    cfg.scene.num_envs = args_cli.num_envs
    env = CartDoublePendulumEnv(cfg=cfg, render_mode=None)
    device = env.device
