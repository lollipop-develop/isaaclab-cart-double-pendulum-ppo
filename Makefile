# Makefile for the cart double pendulum + PPO project.
#
# Workflow:
...
#   make train MAX_ITERS=600 RUN_NAME=swingup_1
...
# Useful when RESUMing to start action_std at the previous run's end value
# (e.g. 0.15) instead of jumping back to the init default (0.6).
ACTION_STD_INIT ?=
